...
#### Will show the effect of the 3-way interactions.
...
#### Allows to test for 2-way interactions. 
drop1(zi.nb.of.4choice.3, test = "Chisq")
 #### 2-way interactions found; ratio and condition, condition and block. 


#### The final chosen model:
zi.nb.of.4choice.32 <- zeroinfl(fly_numbers ~ 
...
#### Testing the inyeraction effects just to confirm.
drop1(zi.nb.of.4choice.32, test = "Chisq")
