...
onefour_m <- rbind(four_to_one_male_b1, four_to_one_male_b2)
...
fourone_m <- rbind(one_to_four_male_b1, one_to_four_male_b2)
...
ovod1_female_feeding <- grid.arrange(of_1_4, of_4_1,
                                     nrow = 1,
                                     widths = c(0.5,0.5),
                                     heights = c(1))
...
ggsave(filename = "ovod1_female_feeding.png", 
       plot = ovod1_female_feeding, 
       width = 10, 
       height = 6, 
       dpi = 300)
...
## Using grid.arrange to put the plots together
virgin_female_feeding <- grid.arrange(vf_1_4, vf_4_1,
                                       nrow = 1,
                                       widths = c(0.5,0.5),
                                       heights = c(1))
...
## Saving the plot
ggsave(filename = "virgin_female_feeding.png", 
       plot = virgin_female_feeding, 
       width = 10, 
       height = 6, 
       dpi = 300)

ggsave(filename = "vf_combined.png", 
       plot = vf_combined, 
       width = 10, 
       height = 6, 
       dpi = 300)
...
ggsave(filename = "of_combined.png", 
       plot = of_combined, 
       width = 10, 
       height = 6, 
       dpi = 300)
...
ggsave(filename = "m_combined.png", 
       plot = m_combined, 
       width = 10, 
       height = 6, 
       dpi = 300)
...
## Using grid.arrange to put the plots together
male_feeding <- grid.arrange(m_1_4, m_4_1,
                                      nrow = 1,
                                      widths = c(0.5,0.5),
                                      heights = c(1))
...
## Saving the plot
ggsave(filename = "male_feeding.png", 
       plot = male_feeding, 
       width = 10, 
       height = 6, 
       dpi = 300)
...
## Saving the plot
ggsave(filename = "virgin_feeding.png", 
       plot = virgin_feeding, 
       width = 10, 
       height = 6, 
       dpi = 300)
