...
# First plot
m1_2 <- ggplot(d1_2, aes(x = weight1, y = weight2, group = 1)) +
  geom_point() +         
  geom_line() +  
  ylim(0.6, 1) + 
  xlim(0.6, 1) +
...
# Second plot
m2_3 <- ggplot(d2_3, aes(x = weight2, y = weight3, group = 1)) +
  geom_point() +         
  geom_line() +  
  ylim(0.6, 1) + 
  xlim(0.6, 1) +
...
# Third plot
m3_1 <- ggplot(d3_1, aes(x = weight3, y = weight1, group = 1)) +
  geom_point() +         
  geom_line() +  
  ylim(0.6, 1) + 
  xlim(0.6, 1) +
...
# First plot
f1_2 <- ggplot(df1_2, aes(x = weight1, y = weight2, group = 1)) +
  geom_point() +         
  geom_line() +  
  ylim(1, 1.6) + 
  xlim(1, 1.6) + 
...
# Second plot
f2_3 <- ggplot(df2_3, aes(x = weight2, y = weight3, group = 1)) +
  geom_point() +         
  geom_line() +  
  ylim(1, 1.6) + 
  xlim(1, 1.6) + 
...
# Third plot
f3_1 <- ggplot(df3_1, aes(x = weight3, y = weight1, group = 1)) +
  geom_point() +         
  geom_line() +  
  ylim(1, 1.6) + 
  xlim(1, 1.6) + 
