...
## Import Data
conditioned_diets <- read_excel("data/male_conditioning.xlsx")

## Making the data long 
male_conditioned_diets_long <- conditioned_diets %>% 
...
conditioned_diets_plot <- male_conditioned_diets_summary %>% 
