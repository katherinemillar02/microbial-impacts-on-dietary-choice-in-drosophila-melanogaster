...
# For visualization of random effects in linear regressions:
# http://mfviz.com/hierarchical-models/
#
#

# Here are some good rules of thumb for GLMMs regarding how many levels
# of a random factor are needed to model it as a random effect by 
# conventional REML methods, and how many observations you'd ideally like
# to have for each of those levels of your random factor, from
# Bolker et al. (2009), DOI: 10.1016/j.tree.2008.10.008:
# "Restrict the model a priori to a feasible
# level of complexity, based on rules of thumb (>5–6 random-effect
# levels per random effect and >10–20 samples [or observations] per 
# [level of any fixed or random factor] ...) ..."
#
# This is because a mixed-effects or hierarchical model is a
# model within a model, and you cannot feasibly fit a distribution 
# around too few levels. 
#
#

# Pertaining to m2 below
# Citation for fitting observation-level random effects for fixing the p values
# of overdispersed models generalized linear models
# e.g. Harrison (2015), DOI: 10.7717/peerj.1114) 

# Pertaining to m4 below
# The motivation for mod3 (below) is the answer here:
# https://stats.stackexchange.com/questions/228800/crossed-vs-nested-random-effects-how-do-they-differ-and-how-are-they-specified

# Other resources on general(ized) linear mixed models topic:
# Harrison et al. (2017), DOI: 10.7717/peerj.4794
# Villemereuil et al. (2016), DOI: 10.1534/genetics.115.186536
#
#
...
#       
#           One random effects:
#     "plate" (modeled as a random effect)
#
#     Didn't make a "replicate block" effect
#    b/c there are too many ways, but we could... 
# 
##################################
...
library(lme4)
library(car)
library(MuMIn) ### Can't get this package
library(broom)
library(broom.mixed)
library(purrr)
library(dplyr) 
...
sims = replicate(n = 1000, # number of simulations
...
sims[[1000]] # e.g. the 1000th data set/model
